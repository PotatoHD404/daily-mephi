...
export default function User(props: { name?: string, userCourse?: string, rating?: number, reviews?: number, materials?: number, quotes?: number, avatar?: string, place?: number, role?: string, me?: boolean, isLoading?: boolean }) {
