...
function a(e, t, n) {
    ...
    window.addEventListener("DOMContentLoaded", (function () {
        ...
        a.style.position = "fixed", "left" == o.dataset.position ? a.style.left = parseInt(o.dataset.x_margin, 10) + 84 + "px" : a.style.right = parseInt(o.dataset.x_margin, 10) + 84 + "px", a.style.bottom = parseInt(o.dataset.y_margin, 10) - 2 + "px", a.style.background = "#ffffff", a.style.zIndex = "9999", a.innerText = o.dataset.message, a.style.boxShadow = "-6px 0px 30px rgba(13, 12, 34, 0.1)", a.style.padding = "23px 24px", a.style.borderRadius = "4px", a.style.fontSize = "18px", a.style.color = "#0D0C22", a.style.width = "auto", a.style.maxWidth = "260px", a.style.lineHeight = "1.5", a.style.fontFamily = '"Avenir Book1", "Avenir Book2", "Avenir Book3", "Avenir Book4", "Avenir Book5", "Avenir Book6", sans-serif', setTimeout(() => {
            a.style.display = "none", a.style.opacity = "0"
        }, 5e3), document.body.appendChild(t), t.appendChild(n), document.body.appendChild(e), document.body.appendChild(a);
        var s = 0;
        e.onclick = function () {
            s || (n.src = "https://www.buymeacoffee.com/widget/page/" + o.dataset.id + "?description=" + encodeURIComponent(o.dataset.description) + "&color=" + encodeURIComponent(o.dataset.color)), s++, a.style.display = "none", a.style.opacity = "0", t.style.width = "100%", t.style.height = "100%", n.style.height = "calc(100% - 140px)", n.style.opacity = "1", e.style.transform = "scale(.8)", e.innerHTML = '<svg width="16" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14.1133 0L8 6.11331L1.88669 0L0 1.88663L8 9.88663L16 1.88663L14.1133 0Z" fill="white"/></svg>'
        ...
        i.includes("visited") || "" == o.dataset.message ? (a.style.display = "none", a.style.opacity = "0") : (document.cookie = `visited=1${d};path=/`, setTimeout(() => {
            a.style.display = "none", a.style.opacity = "0"
        }, 5e3))
    }))