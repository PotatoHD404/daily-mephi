...
(
    ...
    url         TEXT,
    full_name   VARCHAR(255) GENERATED ALWAYS AS (CASE
                                                      WHEN first_name IS NULL AND last_name IS NULL
                                                          AND father_name IS NULL THEN NULL
                                                      ELSE (CASE
                                                                WHEN last_name IS NULL THEN ''
                                                                ELSE last_name END || CASE
    ...
    short_name  VARCHAR(128) GENERATED ALWAYS AS (CASE
                                                      WHEN first_name IS NULL AND last_name IS NULL
                                                          AND father_name IS NULL THEN NULL
                                                      ELSE (CASE
                                                                WHEN last_name IS NULL THEN ''
...
CREATE TABLE materials_semesters
(
    id          UUID PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
    material_id UUID                                       NOT NULL,
...
ALTER TABLE users
    ADD CONSTRAINT users_image_id_fkey FOREIGN KEY (image_id) REFERENCES files (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE comments
    ADD CONSTRAINT comments_user_id_fkey FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE comments
    ADD CONSTRAINT reviews_comments FOREIGN KEY (review_id) REFERENCES reviews (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE comments
    ADD CONSTRAINT materials_comments FOREIGN KEY (material_id) REFERENCES materials (id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE files
    ADD CONSTRAINT files_material_id_fkey FOREIGN KEY (material_id) REFERENCES materials (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE materials
    ADD CONSTRAINT materials_user_id_fkey FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE materials
    ADD CONSTRAINT materials_tutor_id_fkey FOREIGN KEY (tutor_id) REFERENCES tutors (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE legacy_ratings
    ADD CONSTRAINT legacy_ratings_tutor_id_fkey FOREIGN KEY (tutor_id) REFERENCES tutors (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE quotes
    ADD CONSTRAINT quotes_user_id_fkey FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE quotes
    ADD CONSTRAINT quotes_tutor_id_fkey FOREIGN KEY (tutor_id) REFERENCES tutors (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE rates
    ADD CONSTRAINT rates_tutor_id_fkey FOREIGN KEY (tutor_id) REFERENCES tutors (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE rates
    ADD CONSTRAINT rates_user_id_fkey FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE reviews
    ADD CONSTRAINT reviews_tutor_id_fkey FOREIGN KEY (tutor_id) REFERENCES tutors (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE reviews
    ADD CONSTRAINT reviews_user_id_fkey FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE reactions
    ADD CONSTRAINT reactions_user_id_fkey FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE reactions
    ADD CONSTRAINT reactions_quote_id_fkey FOREIGN KEY (quote_id) REFERENCES quotes (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE reactions
    ADD CONSTRAINT reactions_material_id_fkey FOREIGN KEY (material_id) REFERENCES materials (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE reactions
    ADD CONSTRAINT reactions_review_id_fkey FOREIGN KEY (review_id) REFERENCES reviews (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE reactions
    ADD CONSTRAINT reactions_comment_id_fkey FOREIGN KEY (comment_id) REFERENCES comments (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE reactions
    ADD CONSTRAINT reactions_news_id_fkey FOREIGN KEY (news_id) REFERENCES news (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE documents
    ADD CONSTRAINT documents_user_id_fkey FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE documents
    ADD CONSTRAINT documents_tutor_id_fkey FOREIGN KEY (tutor_id) REFERENCES tutors (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE documents
    ADD CONSTRAINT documents_material_id_fkey FOREIGN KEY (material_id) REFERENCES materials (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE documents
    ADD CONSTRAINT documents_review_id_fkey FOREIGN KEY (review_id) REFERENCES reviews (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE documents
    ADD CONSTRAINT documents_quote_id_fkey FOREIGN KEY (quote_id) REFERENCES quotes (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE documents
    ADD CONSTRAINT documents_news_id_fkey FOREIGN KEY (news_id) REFERENCES news (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE tutors_disciplines
    ADD CONSTRAINT tutors_disciplines_discipline_id_fkey FOREIGN KEY (discipline_id) REFERENCES disciplines (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE tutors_disciplines
    ADD CONSTRAINT tutors_disciplines_tutor_id_fkey FOREIGN KEY (tutor_id) REFERENCES tutors (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE materials_disciplines
    ADD CONSTRAINT materials_disciplines_discipline_id_fkey FOREIGN KEY (discipline_id) REFERENCES disciplines (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE materials_disciplines
    ADD CONSTRAINT materials_disciplines_material_id_fkey FOREIGN KEY (material_id) REFERENCES materials (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE tutors_faculties
    ADD CONSTRAINT tutors_faculties_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES faculties (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE tutors_faculties
    ADD CONSTRAINT tutors_faculties_tutor_id_fkey FOREIGN KEY (tutor_id) REFERENCES tutors (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE materials_faculties
    ADD CONSTRAINT materials_faculties_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES faculties (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE materials_faculties
    ADD CONSTRAINT materials_faculties_material_id_fkey FOREIGN KEY (material_id) REFERENCES materials (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE materials_semesters
    ADD CONSTRAINT materials_semesters_material_id_fkey FOREIGN KEY (material_id) REFERENCES materials (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE materials_semesters
    ADD CONSTRAINT materials_semesters_semester_id_fkey FOREIGN KEY (semester_id) REFERENCES semesters (id) ON DELETE CASCADE ON UPDATE CASCADE;
